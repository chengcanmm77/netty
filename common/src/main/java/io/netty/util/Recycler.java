    ...
    static final class Stack<T> {
        ...
        void push(DefaultHandle<?> item) {
            ...
            if (thread == currentThread) {
                ...
                // The current Thread is not the one that belongs to the Stack, we need to delay the actual push.
                pushDelayed(item, currentThread);
            }
        }
        ...
        private void pushDelayed(DefaultHandle<?> item, Thread thread) {
