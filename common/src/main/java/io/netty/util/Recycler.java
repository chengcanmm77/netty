...
public abstract class Recycler<T> {
    ...
    static {
        ...
        // bursts.
        RATIO = MathUtil.findNextPositivePowerOfTwo(
                max(SystemPropertyUtil.getInt("io.netty.recycler.ratio", 8), 2));
    ...
    protected Recycler(int maxCapacity, int maxSharedCapacityFactor, int ratio) {
        if (maxCapacity <= 0) {
            ...
            ratioMask = MathUtil.findNextPositivePowerOfTwo(ratio) - 1;
        }
    }
